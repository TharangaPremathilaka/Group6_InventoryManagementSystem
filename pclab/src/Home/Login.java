...
public Login() {
        ...
        try {
           ...
           // cn=DriverManager.getConnection("jdbc:mysql://localhost/PCLabStore", "root", "942944560v");
           cn=DriverManager.getConnection("jdbc:mysql://localhost/PCLabStore", "root", "942944560v");
    ...
    private void subActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_subActionPerformed
       /* try {
            String sql=" select *from user where username = '"+user1.getText()+"'and password = '"+String.valueOf(pass1.getPassword())+"'";
      ...
      //close();
        ...
        try {
            ...
            ps.setString(2, String.valueOf(pass1.getPassword()));
            ResultSet rs=ps.executeQuery();
            NewWelcome nw  = new NewWelcome();
                 nw.setVisible(true);
                 nw.show();
                 Thread.sleep(2000);
            if(rs.next())
