...
public class CreateBill extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Quantity", "Name", "Unit Price", "Price"
            }
        ));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MyFrames/up.png"))); // NOI18N
 ...
 public void billno()
 {
   ...
   String query="INSERT INTO `bill`(bno,`cname`,amt,`pdate`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"',"+jTextField7.getText()+",'"+jTextField8.getText()+"');";
       ...
       Statement st;
       try{
            con = con=DriverManager.getConnection("jdbc:mysql://localhost/PCLabStore", "root", "942944560v");
...
//Sum of jtable
  ...
  // ResultSet rs1;
     ...
     catch(Exception e)
     {
      ...
      public double getsum()
      {
          ...
          jTextField7.setText(df.format(sum));
          return sum;
      }
  ...
  // ResultSet rs1;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        //billupdate();
        MessageFormat header=new MessageFormat("Payment Report  "+"--  Total Bill Amount = "+Double.toString(getsum()));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        billupdate();
        JOptionPane.showMessageDialog(null, "Bill created sucssessfuly!");
